...
import readFile from "../repository/readFile.js";
    ...
    try {
      ...
      for (const entry of entries) {
        if (entry.isFile()) {
          ...
          this.emit("file-processed", fullPath);
        }
      }
      const duplicates = [];
      ...
      //   console.log("Duplicate files found5555:", duplicates);
      this.emit("duplicates-found", { duplicates, totalDuplicateSize, secret: this.secret });
    } catch (error) {
